...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation (Context context, AttributeSet attrs) {
        ...
        mFromDegrees = a.getFloat(R.styleable.Rotate3dAnimation_dialogFromDeg, 0.0f);
        mToDegrees = a.getFloat(R.styleable.Rotate3dAnimation_dialogToDeg, 0.0f);
        mRollType = a.getInt(R.styleable.Rotate3dAnimation_dialogRollType, ROLL_BY_X);
        Description d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_dialogPivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_dialogPivotY));
        mPivotYType = d.type;
