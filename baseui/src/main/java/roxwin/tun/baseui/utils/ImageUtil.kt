...
object ImageUtil {
    fun renGradientLogin(color: List<String?>): GradientDrawable? {
        return try {
    ...
    fun ren4Corner(color: String?, radius: Float): GradientDrawable? {
        return try {
